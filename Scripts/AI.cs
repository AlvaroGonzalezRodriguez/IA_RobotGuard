...
public class AI : MonoBehaviour
{
	...
	bool knowsLastPlayerPosition = false;
	
	[Task]
	public void SaveLastTargetPosition()
	{
		knowsLastPlayerPosition = true;
	...
	[Task]
    public bool KnowsLastPlayerPosition() {
        return knowsLastPlayerPosition;
    }

    [Task] 
    public void SetKnowsLastPlayerPosition(bool b){
        knowsLastPlayerPosition = b;
        Task.current.Succeed();
    }
}
